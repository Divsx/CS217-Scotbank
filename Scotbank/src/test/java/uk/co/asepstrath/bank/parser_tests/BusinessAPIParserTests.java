...
public class BusinessAPIParserTests {
	...
	public void checkParseResponse() throws InvocationTargetException, IllegalAccessException, NoSuchMethodException {
		// Make class
		BusinessAPIParser parser = new BusinessAPIParser(mock(Logger.class), "http://127.0.0.1:5000/api/businesses", mock(DataSource.class));
		...
		BusinessAPIParser err_parser = new BusinessAPIParser(mock(Logger.class), "http://127.0.0.1:5000/api/transactions", mock(DataSource.class));
