...
public class AccountAPIParserTests {
	...
	*/
	...
	public void checkParseResponse() {
		try {
			// Make class
			AccountAPIParser parser = new AccountAPIParser(mock(Logger.class), "http://127.0.0.1:5000/api/accounts", mock(DataSource.class));
			...
			AccountAPIParser err_parser = new AccountAPIParser(mock(Logger.class), "http://127.0.0.1:5000/api/transactions", mock(DataSource.class));
