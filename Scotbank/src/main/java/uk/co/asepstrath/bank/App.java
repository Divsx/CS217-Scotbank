    ...
    */
    public void onStart() {
        ...
        try(Connection connection = ds.getConnection()) {
            ...
            stmt.executeUpdate("INSERT INTO Users VALUES ('dbf368f3-3539-4e8c-89d9-e1d1e9c561d6', 'username', '" + hashed_password + "')");
			...
			AccountAPIParser account_parser = new AccountAPIParser(log, "http://127.0.0.1:5000/api/accounts", ds);
            account_parser.writeAPIInformation();

			BusinessAPIParser business_parser = new BusinessAPIParser(log, "http://127.0.0.1:5000/api/businesses", ds);
            business_parser.writeAPIInformation();

			TransactionAPIParser transaction_parser = new TransactionAPIParser(log, "http://127.0.0.1:5000/api/transactions", ds);
